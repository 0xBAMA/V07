...
int main()
{
  ...
  // The environment - land and sky
    main_block->draw_sphere(vec(255.5, 127.5, 127.5), 500, main_block->get_vox( 57, 0.8, false) );

    main_block->draw_sphere(vec(400, 127.5, 200), 100, main_block->get_vox( 57, 20, false) );
  ...
  // cutout for courtyard
    ...
    main_block->draw_quadrilateral_hexahedron(a, b, c, d, e, f, g, h, main_block->get_vox(57, 0.8, false) );
  ...
  // cut out space for towers
    main_block->draw_cylinder(a, b, 12, main_block->get_vox(57, 0.8, false) );
    main_block->draw_cylinder(c, d, 12, main_block->get_vox(57, 0.8, false) );
    main_block->draw_cylinder(e, f, 12, main_block->get_vox(57, 0.8, false) );
    main_block->draw_cylinder(g, h, 12, main_block->get_vox(57, 0.8, false) );
  ...
  // cutout for the top stair (quarter circle)
    main_block->draw_triangle(fe_tower_location, fe_tower_location + displacement_vectors[7], fe_tower_location + displacement_vectors[0], 3.0, main_block->get_vox(57, 0.8, false) );
    main_block->draw_triangle(ba_tower_location, ba_tower_location + displacement_vectors[7], ba_tower_location + displacement_vectors[0], 3.0, main_block->get_vox(57, 0.8, false) );
    main_block->draw_triangle(dc_tower_location, dc_tower_location + displacement_vectors[7], dc_tower_location + displacement_vectors[0], 3.0, main_block->get_vox(57, 0.8, false) );
    main_block->draw_triangle(hg_tower_location, hg_tower_location + displacement_vectors[7], hg_tower_location + displacement_vectors[0], 3.0, main_block->get_vox(57, 0.8, false) );

    main_block->draw_triangle(fe_tower_location, fe_tower_location + displacement_vectors[0], fe_tower_location + displacement_vectors[1], 3.0, main_block->get_vox(57, 0.8, false) );
    main_block->draw_triangle(ba_tower_location, ba_tower_location + displacement_vectors[0], ba_tower_location + displacement_vectors[1], 3.0, main_block->get_vox(57, 0.8, false) );
    main_block->draw_triangle(dc_tower_location, dc_tower_location + displacement_vectors[0], dc_tower_location + displacement_vectors[1], 3.0, main_block->get_vox(57, 0.8, false) );
    main_block->draw_triangle(hg_tower_location, hg_tower_location + displacement_vectors[0], hg_tower_location + displacement_vectors[1], 3.0, main_block->get_vox(57, 0.8, false) );
  ...
  // tower caps
    ...
    main_block->draw_cylinder(a+vec(0,2,0), a+vec(0,8,0), 10, main_block->get_vox(57, 0.8, false) );
    main_block->draw_cylinder(c+vec(0,2,0), c+vec(0,8,0), 10, main_block->get_vox(57, 0.8, false) );
    main_block->draw_cylinder(e+vec(0,2,0), e+vec(0,8,0), 10, main_block->get_vox(57, 0.8, false) );
    main_block->draw_cylinder(g+vec(0,2,0), g+vec(0,8,0), 10, main_block->get_vox(57, 0.8, false) );
  ...
  // crenelations for towers - lengthen displacement vectors
    ...
    for(int i = 0; i < 8; i++)
    {
      main_block->draw_cylinder(a+vec(0,8,0), a+vec(0,8,0)+displacement_vectors[i], 2, main_block->get_vox(57, 0.8, false) );
      main_block->draw_cylinder(c+vec(0,8,0), c+vec(0,8,0)+displacement_vectors[i], 2, main_block->get_vox(57, 0.8, false) );
      main_block->draw_cylinder(e+vec(0,8,0), e+vec(0,8,0)+displacement_vectors[i], 2, main_block->get_vox(57, 0.8, false) );
      main_block->draw_cylinder(g+vec(0,8,0), g+vec(0,8,0)+displacement_vectors[i], 2, main_block->get_vox(57, 0.8, false) );
    }
  ...
  // empty layer
    ...
    // upper walkway
    main_block->draw_quadrilateral_hexahedron(wa, wb, wc, wd, we, wf, wg, wh, main_block->get_vox(57, 0.8, false) );

    shift = vec(0,-20, 0);

    // middle walkway
    main_block->draw_quadrilateral_hexahedron(wa+shift, wb+shift, wc+shift, wd+shift, we+shift, wf+shift, wg+shift, wh+shift, main_block->get_vox(57, 0.8, false) );
  ...
  // crown of the doorway
    main_block->draw_cylinder((wa+we)/2.0f, (wc+wg)/2.0f, 3, main_block->get_vox(57, 0.8, false) );

    shift = vec(0,-20, 0);

    // lower walkway
    main_block->draw_cylinder(((wa+we)/2.0f)+shift, ((wc+wg)/2.0f)+shift, 3, main_block->get_vox(57, 0.8, false) );
  ...
  // crown of doorway
    main_block->draw_cylinder((wg+we)/2.0f, (wc+wa)/2.0f, 3, main_block->get_vox(57, 0.8, false) );

    shift = vec(0,-20, 0);

    // lower walkway
    main_block->draw_cylinder(((wg+we)/2.0f)+shift, ((wc+wa)/2.0f)+shift, 3, main_block->get_vox(57, 0.8, false) );
  ...
  // crenelations
    ...
    {
      main_block->draw_cylinder(castle_center+vec(-30+i, 76, 50), castle_center+vec(-30+i, 76, -50), 1, main_block->get_vox(57, 0.8, false) );
      main_block->draw_cylinder(castle_center+vec(50, 76, -30+i), castle_center+vec(-50, 76, -30+i), 1, main_block->get_vox(57, 0.8, false) );
    }
  ...
  // roadway
    ...
    main_block->draw_cylinder( (a+e)/2.0f, (c+g)/2.0f, 10,  main_block->get_vox(57, 0.8, false) );
  ...
  // red carpet
    ...
    main_block->draw_cylinder(internal_staircase_location, internal_staircase_location+vec(0,35,0), 9, main_block->get_vox(57, 0.8, false) );
